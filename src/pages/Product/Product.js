...
const Product = () => {
    return (
        <div >
          <Row style={{marginTop:"0vw", paddingLeft: "10vw"}} >
          ...
          <Row className="container-gap" style={{backgroundColor: " #5300A1", paddingTop: "4vw", paddingBottom: "4vw", color: "white"}}>
            ...
            <Button style={{backgroundColor:"#14ffd8", padding:"10px", color: "#010042", fontWeight: "700", borderStyle: "hidden"}} className="row-margin closer  center">Sign up for beta testing &#62;</Button>
            </Col>
          </Row>
